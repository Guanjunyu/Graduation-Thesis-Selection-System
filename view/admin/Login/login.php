                ...
                <form class="layui-form" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <input type="password" name="password" id="password" lay-verify="required|password"
                            placeholder="密码" autocomplete="off" class="layui-input" required value="qqq123!A">
                    ...
                    <div class="layui-form-item">
                        ...
                        <input type="text" name="captcha" lay-verify="required|captcha" placeholder="图形验证码"
                            autocomplete="off" class="layui-input verification captcha" required maxlength="5"
                            value="qwer">
                    ...
                    <div class="layui-form-item" style="position: relative;">
                        ...
                        <div class="div-forget-password">
                            <a href="..\Common\Reset\index" class="forget-password">忘记密码？</a>
                        </div>
                    </div>
