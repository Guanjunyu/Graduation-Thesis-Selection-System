...
<body style="padding:10px; box-sizing: border-box;">
	...
	<form class="layui-form layui-form-pane">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="number" class="layui-input" name="sort" placeholder="请输入权重,值越大越靠前" required
				 lay-verify="required|number" title="最小为0,最大为999的权重" oninput="if(value.length>3)value=value.slice(0,3)">
			</div>
		</div>
		...
		<div class="layui-form-item" style="width:100%;">
			...
			<div class="layui-input-block">
				<select name="type" lay-filter="type" lay-verify="required">
					<option value='0' selected>分组</option>
...
<script>
	...
	layui.use(['form','layer'],function name() {
		...
		form.on('submit(save)', function (data) {
			...
			$.ajax({
				type: "post",
				url: "{:url('../../common/navigation/menuadd')}",
				data: data.field,
				dataType: 'json',
