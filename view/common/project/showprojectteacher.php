	...
	<table class="layui-table">
		<thead>
			<tr>
                ...
                <th style="text-align:center;">选题学生</th>
                <th style="text-align:center;">课题详情</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<td style="text-align:center;">
					...
					{/if}
				<th style="text-align:center;">{$vo.checked==0?'<span style="color:red;">未选择</span>':'已选择'}</th>
                <td style="text-align:center;">{:isset($name[$vo.studentid])?$name[$vo.studentid]['name']:''}</td>
