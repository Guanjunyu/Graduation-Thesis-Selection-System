	...
	<table class="layui-table">
		...
		<tbody>
			...
			<tr>
				...
				<td style="text-align:center;">
					<button type="button" class="layui-btn layui-btn-primary layui-btn-xs" onclick="edit({$vo.studentid})">
...
<script>
	...
	function edit(studentid){
		layer.open({
			...
			anim: 1,
			area: ['550px','550px'],
			content: "studentedit?studentid="+studentid
		});
	}
	...
	function del(studentid){
		layer.confirm('确定要删除吗？', {
			...
			$.post("studentdel",{'studentid':studentid},function(res){
				if(res.code!=200){
