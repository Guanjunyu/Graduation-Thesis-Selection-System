...
class TempTeacher extends Validate
{
    protected $regex = [
        'userid1' => '/^[0-9]{12}$/i',
     ...
     */
    protected $rule = [
        'userid' => 'require|number|length:12|regex:userid1|unique:Temp_teacher,teacherid',
        'name' => 'require|regex:name1',
        'sex' => 'require|in:1,0',
        'email' => 'require|email|unique:Temp_teacher,email',
        'role' => 'require|alpha',
